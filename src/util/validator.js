...
const isValidPinCode = (value) => { return (/^[1-9][0-9]{6}$/).test(value) }
...
module.exports={isValidEmail,isValidObjectId,isValidphone,isValidBody,isValidRequestBody,isValidName,isValidpassword,isValidCity,isValidPinCode,isValidProductName,isValidPrice,isValidateSize,isValidInstallment,isValidImage}